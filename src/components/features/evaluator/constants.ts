...
export const RESPONSE_VISIBLE_FIELDS = [
  ...
  {
    field: "skills.longAnswers4",
    type: "long",
    label: "Long Answer 4",
    scoreName: "ResponseFourScore",
  },
  {
    field: "skills.longAnswers5",
    type: "long",
    label: "Long Answer 5",
    scoreName: "ResponseFiveScore",
  },
  {
    field: "skills.longAnswers6",
    type: "long",
    label: "Long Answer 6",
    scoreName: "ResponseSixScore",
  },
