// note: first level git blame will show `naijwu`, but that's just cuz of formatting
// TODO: refactor this questions to render based on an object
        ...
        <div className="flex items-center gap-3 pb-6">
          ...
          {config && (
            <p className="text-muted-foreground text-sm">
              Last edited by {config.lastEditedBy || "Unknown"} on{" "}
              {formatTimestamp(config.lastEdited)}
            </p>
          )}
        </div>
              ...
              <div className="flex-1 space-y-4">
                <div className="flex flex-col gap-2">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <Label htmlFor="media">Primary (Background)</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "primary")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "primary")
                        }
                        type="color"
                        disabled={!isEditing}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="media">Primary Foreground</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "primaryForeground")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "primaryForeground")
                        }
                        type="color"
                        disabled={!isEditing}
                        placeholder="Enter HEX"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <Label htmlFor="media">Secondary (Background)</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "secondary")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "secondary")
                        }
                        type="color"
                        disabled={!isEditing}
                        placeholder="Enter HEX"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="media">Secondary Foreground</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "secondaryForeground")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "secondaryForeground")
                        }
                        type="color"
                        disabled={!isEditing}
                        placeholder="Enter HEX"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <Label htmlFor="media">Tertiary (Background)</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "tertiary")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "tertiary")
                        }
                        type="color"
                        disabled={!isEditing}
                        placeholder="Enter HEX"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="media">Tertiary Foreground</Label>
                      <Input
                        id="media"
                        value={getValue("hackathonTheme", "tertiaryForeground")}
                        onChange={(e) =>
                          handleFieldChange("hackathonTheme", e.target.value, "tertiaryForeground")
                        }
                        type="color"
                        disabled={!isEditing}
                        placeholder="Enter HEX"
