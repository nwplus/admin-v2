 ...
 */
export const upsertDiscordQuestion = async (
  values: DiscordQuestion,
  server: string,
  questionId?: string,
) => {
  try {
...
export const susbcribeToDiscordQuestions = (
  callback: (docs: DiscordQuestion[]) => void,
  server: string,
) =>
